### Ce que le Modèle Logique permet pour le ROR
...
Ces quatre mécanismes sont implémentés en FSH (FHIR Shorthand). Les fichiers sources sont dans <code>input/fsh/Logicals/</code> et <code>input/fsh/ValueSets/</code>. Le build est automatique via GitHub Actions à chaque push.
</div>
