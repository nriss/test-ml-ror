...
Attributs spécifiques ROR (en complément du MOS) :

| Attribut | Card. | Type | Terminologie |
|---|---|---|---|
| idNatStruct | 1..1 | Identifier | TRE_G07-TypeIdentifiantStructure |
| raisonSociale | 1..1 | string | — |
| statutJuridique | 1..1 | Coding | TRE_R72-FinessStatutJuridique |
| agregatStatutJuridiqueNiv2 | 0..1 | Coding | TRE_R69-FinessAgregatStatutJuridiqueNiv2 |
...
| idNatStruct | 1..1 | Identifier | TRE_G07-TypeIdentifiantStructure |
| raisonSociale | 1..1 | string | — |
| categorieEtablissement | 0..* | Coding | JDV_J55-CategorieEG-ROR |
| modaliteParticipationSPH | 0..1 | Coding | TRE_R73-ESPIC |
| accessibiliteLieu | 0..* | Coding | TRE_R202-AccessibiliteLieu |
| niveauRecoursORSAN | 0..* | Coding | TRE_R284-NiveauRecoursORSAN |
| aideFinanciere | 0..* | Coding | TRE_R241-AideFinanciere |
| typeFermeture | 0..1 | Coding | JDV_J185-typeFermeture-ROR |
| territoireSante | 0..1 | Identifier | — |
| metadonnee | 1..1 | [RORMetadonnee](StructureDefinition-ror-metadonnee.html) | — |
